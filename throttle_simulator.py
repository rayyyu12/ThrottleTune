...
# Supra RPM simulation parameters (adapted from M4)
SUPRA_RPM_IDLE = 900
...
class SupraSoundManager:
    ...
    def load_sounds(self):
        ...
        # Staged Rev Sounds (adapted from M4 approach)
        self.rev_stages = []
...
class SupraEngineSimulation:
    def __init__(self, sound_manager):
        ...
        # RPM simulation (adapted from M4)
...
class ThrottleSimulatorGUI:
    ...
    def setup_gui(self):
        ...
        # Throttle range display for Supra
        self.throttle_range_label = tk.Label(status_frame, text="Throttle Range: N/A", 
